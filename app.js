...
app.get('/comunicados', authenticateToken, async (req, res) => {
    try {
        ...
        // Buscar los comunicados del curso y generales
        ...
        const comunicados = await Comunicado.find({
            $or: [
                { general: true },  // Comunicados generales
                { curso: estudiante.cursoPerteneciente._id }  // Comunicados del curso del estudiante
            ]
